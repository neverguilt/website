      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-slate">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Terms of Use</h2>
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Information Accuracy</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Verification Services</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Limitation of Liability</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Privacy Policy</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Third-Party Links</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Changes to Disclaimer</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-2xl font-bold text-neverguilt-dark">Contact Us</h2>
            <p className="text-gray-600">
           ...
           {/* CTA Section */}
      <section className="py-12 bg-neverguilt-dark text-white">
